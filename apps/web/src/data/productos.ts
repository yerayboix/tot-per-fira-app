export const productosPorCategoria = {
  ...
  alcohol: [
    // GINEBRA
    { nombre: 'Seagrams 0.7L' },
    { nombre: 'Seagrams 1L' },
    { nombre: 'Beefeater 0.7L' },
    { nombre: 'Beefeater 1L' },
    { nombre: 'Larios 0.7L' },
    { nombre: 'Larios 1L' },
    { nombre: 'Puerto de Indias 0.7L' },
    { nombre: 'Puerto de Indias 1L' },
    { nombre: 'Larios Rose 0.7L' },
    { nombre: 'Larios Rose 1L' },
    
    // WHISKY
    { nombre: 'Red Label 0.7L' },
    { nombre: 'Red Label 1L' },
    { nombre: 'Ballantines 0.7L' },
    { nombre: 'Ballantines 1L' },
    { nombre: 'Cutty Sark 0.7L' },
    { nombre: 'Cutty Sark 1L' },
    ...
    // VODKA
    { nombre: 'Smirnoff 0.7L' },
    { nombre: 'Smirnoff 1L' },
    { nombre: 'Absolut 0.7L' },
    { nombre: 'Absolut 1L' },
    { nombre: 'Eristoff 0.7L' },
    { nombre: 'Eristoff 1L' },
    { nombre: 'Vodka Sabores 0.7L' },
    { nombre: 'Vodka Sabores 1L' },
    
    // LICORES
    { nombre: 'Jägermeister 0.7L' },
    { nombre: 'Jägermeister 1L' },
    { nombre: 'Tequila 0.7L' },
    { nombre: 'Tequila Sabores 0.7L' },
    { nombre: 'Licor de Arroz 1L' },
    { nombre: 'Licor de Arroz 3L' },
    { nombre: 'Licor de Arroz 5L' },
    { nombre: 'Limoncello 1L' },
    { nombre: 'Limoncello 3L' },
    { nombre: 'Limoncello 5L' },
    { nombre: 'Baileys 0.7L' },
    { nombre: 'Peché 0.7L' },
    { nombre: 'Fireball 0.7L' },
    { nombre: 'Malibú 0.7L' },
    { nombre: 'Malibú 1L' },
  ],
